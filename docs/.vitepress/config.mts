        ...
        '/frontend/': [
          {
            ...
            items: [
              ...
              { text: '浏览器原理深入', link: '/frontend/fundamentals/browser-internals-deep-dive' },
              ...
              { text: 'Web API 深入', link: '/frontend/fundamentals/web-api-deep-dive' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Vue3 响应式原理', link: '/frontend/vue/vue3-reactivity-deep-dive' },
              { text: 'Vue3 编译器原理', link: '/frontend/vue/vue3-compiler-deep-dive' },
