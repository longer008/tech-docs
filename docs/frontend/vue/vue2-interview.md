...
> Vue 2 已于 2023 年 12 月 31 日停止维护（EOL），建议新项目使用 Vue 3。本文档仅供维护旧项目参考。
>
> Vue 2.x 版本核心知识点与高频面试题
>
> 📅 **更新时间**: 2026-05
>
> 📚 **内容来源**: Vue 2 官方文档、Vuex 官方文档

[[toc]]

> **注意**：Vue 2 已于 2023-12-31 正式 EOL（停止维护）。本页仅供历史项目维护与面试对比参考，新项目请使用 Vue 3。
...
Vue 2 已于 2023 年 12 月 31 日停止官方维护，不再发布新版本或修复 bug。

### 面试新增考点

Q: **Vue 2 项目如何迁移到 Vue 3？**

A: 核心步骤：
1. 使用 `@vue/compat` 兼容构建版本渐进迁移
2. 替换 Vuex → Pinia
3. 替换 Options API → Composition API
4. 替换 Vue Router 3 → Vue Router 4
5. 替换 Element UI → Element Plus

Q: **为什么 Vue 2 不再维护？**

A: Vue 3 的 Composition API、响应式系统（Proxy）、编译优化（静态提升/树结构打平）在架构上更优越，维护两套系统成本过高。社区已全面转向 Vue 3。
